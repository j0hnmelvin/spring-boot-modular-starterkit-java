...
- **user-service**
  - This example module illustrates how to protect a Java REST API using Microsoft Entra ID by restricting access to its resources to authorized accounts only.
